...
<section class="products-section section section--glass" id="products">
    ...
    <div class="container-wide section-content">
        <div class="section-title fade-in">
            ...
            <h2><?php echo pf_output_html($products_title); ?></h2>
        ...
        <?php if ($products_query->have_posts()): ?>
            <div class="grid grid-3 products-grid">
                ...
                while ($products_query->have_posts()):
                    ...
                    $price = $price_raw !== '' ? pf_clean_float($price_raw) : '';
                    $stock = pf_clean_text(get_post_meta(get_the_ID(), '_product_stock', true));
                    $animation_class = $animations[$index % count($animations)];
                    $delay_value     = $index * 0.1;
                    ?>
                    <article class="card product-card fade-in <?php echo pf_output_attr($animation_class); ?>" style="--animation-delay: <?php echo pf_output_attr(number_format($delay_value, 2, '.', '')); ?>s;">
                        ...
                        <div class="product-content">
                            ...
                            <div class="product-footer">
                                ...
                                <a href="<?php echo pf_output_url(putrafiber_whatsapp_link('Halo, saya tertarik dengan produk: ' . get_the_title())); ?>" class="btn btn-primary btn-sm" target="_blank" rel="noopener">
        ...
        <div class="section-cta fade-in">
            <a href="<?php echo pf_output_url(get_post_type_archive_link('product')); ?>" class="btn btn-outline btn-lg">

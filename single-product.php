        ...
        <div class="product-info">
          ...
          <?php if (!empty($short_desc)): ?>
            <div class="product-short-description">
              <?php // Gunakan wpautop untuk menjaga format paragraf dan line break dari deskripsi singkat.
              echo wpautop(pf_output_html($short_desc)); ?>
            </div>
          <?php endif; ?>
          ...
          <div class="product-share">
            ...
            <div class="share-buttons">
              <?php
              $share_url_raw = get_permalink();
              $share_url_encoded = urlencode($share_url_raw);
              $share_title_encoded = urlencode(get_the_title());
              ?>
              <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo $share_url_encoded; ?>"
              ...
              <a href="https://twitter.com/intent/tweet?url=<?php echo $share_url_encoded; ?>&text=<?php echo $share_title_encoded; ?>"
              ...
              <a href="https://api.whatsapp.com/send?text=<?php echo $share_title_encoded . rawurlencode(' - ') . $share_url_encoded; ?>"
        ...
        <div class="specs-grid">
          <?php if ($specs): ?>
            <div class="specs-box">
              <h2>📋 Spesifikasi</h2>
              <ul>
                <?php // Gunakan preg_split untuk menangani berbagai jenis line ending (\n, \r\n)
                foreach (preg_split('/\r\n|\r|\n/', $specs) as $line) {
